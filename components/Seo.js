...
const settings = {
  titleEnding: "| Bee Orchid Press",
  company: "Bee Orchid Press",
  author: "Lorenza Weinle",
  language: "en",
  themeColor: "#5185FF",
  baseUrl: "https://beeorchidpress.com",
};
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:type" content="books.publisher" />
